...
side_by_side <- function(sim, res)
{
    ...
    phy_gt.f <- fortify(as.phylo(phy_gt), layout="slanted")
    ...
    plt_ci <- plot_densiCI(res,mrsd=mrsd, layout="slanted", n_samp=250, tip.order=tip_ord_gt) + ggtitle("Densitree With CIs For Majority Clades") 

    plt_gt <- ggtree(tr=phy_gt.tbl, layout="slanted", aes(color = msize>2)) + 
        scale_color_manual(values=c("red","blue")) +
        geom_tippoint(color="black", size=0.5) +
