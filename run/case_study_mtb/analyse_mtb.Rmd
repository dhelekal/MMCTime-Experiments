...
df_beta <- foo(res_beta,c("alpha","nu","mu","omega", "tree_length"))
df_kmb <- foo(res_kmb,c("phi","alpha","nu","mu","omega", "tree_length"))
df_kingman <- foo(res_kingman,c("nu","mu","omega", "tree_length"))
```
