...
sum_plt <- function(df)
{
    ...
    allDf <- df[df$variable %in% c("mu", "nu", "omega", "alpha", height_n),]
    ...
    gt_df <- melt(gt_df, measure.vars=c("alpha", "nu","omega","mu", height_n))
    
    gt_df$variable <- factor(gt_df$variable, levels=c("alpha", "nu","omega","mu", height_n))
    allDf$variable <- factor(allDf$variable, levels=c("alpha", "nu","omega","mu", height_n))
    conv_df$variable <-  factor(conv_df$variable, levels=c("alpha", "nu","omega","mu", height_n))
